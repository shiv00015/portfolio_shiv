      ...
      sm:p-20" id="contact_me">
        <form className="max-w-md mx-auto p-6 bg-transparent shadow-md rounded-lg space-y-4" action="https://formspree.io/f/your-form-id" method="POST">
          ...
          <div>
            ...
            <textarea name="message" rows="4" required class="w-full border border-gray-300 rounded px-3 py-2 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
          </div>
